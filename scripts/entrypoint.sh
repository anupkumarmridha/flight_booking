...
python manage.py migrate booking || { echo "Failed to apply migrations for booking app"; exit 1; }
echo "Applying migrations for home app..."
python manage.py migrate home || { echo "Failed to apply migrations for home app"; exit 1; }
